...
def Server():
    ...
    my_socket.bind(('0.0.0.0', 8889))  # ✅ Perbaikan: port diubah menjadi 8889
    my_socket.listen(1)

    logging.warning("🚀 Server process pool aktif di port 8889 (1 proses aktif untuk layanan bergantian).")
    ...
    with ThreadPoolExecutor(1) as executor:
        while True:
            ...
            print(f"🔁 Jumlah proses aktif: {aktif}")
